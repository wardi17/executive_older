        ...
        <form  id ="formtambah"  class ="form form-horizontal">
                    ...
                    <div class="row col-md-12 mb-3">  
                        ...
                        <div class="row col-md-12">  
                                <label for="nama_kjn" class="col-sm-4 col-form-label">Jenis EO</label>
                                <div class="col-sm-6">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                  ...
                  <div class="row col-md-12 mb-3">  
                      ...
                      <div class="row col-md-12 mb-3">  
                              <label for="kjn_delete" class="col-sm-4 col-form-label">Jenis EO</label>
                              <div class="col-sm-6">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <form  id ="formedit"  class ="form form-horizontal">
                  <div class="row col-md-12 mb-4">  
                      ...
                      <div class="row col-md-12">  
                              <label for="nama_edit" class="col-sm-4 col-form-label">Jenis EO</label>
                              <div class="col-sm-5">
...
function get_header(){
    ...
    <h4 class="text-center">Master Jenis EO </h4>
    </div></div>
