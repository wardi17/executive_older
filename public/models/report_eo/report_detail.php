...
image1,image2,image3,image4,user_id,tgl_upload,posting,catatan,tgl_posting FROM transaksi_executive WHERE YEAR(tanggal) ='".$tahun."' AND jenis_eo='".$jenis."' ORDER BY tanggal DESC";
...
while(odbc_fetch_row($result2)){
  ...
  foreach($data as $datas){
    $full_data[] =[
      ...
      'attach_bp' =>get_data_atter($conn,$datas['id_eo'],$id_attach="BP"),
      'attach_af' =>get_data_atter($conn,$datas['id_eo'],$id_attach="AF"),
      'attach_bf' =>get_data_atter($conn,$datas['id_eo'],$id_attach="BF"),
    ];
