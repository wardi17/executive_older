...
$sql=odbc_exec($conn,$query);
 ...
 $kode_log = (isset($_SESSION['kode_log_exe']))? $_SESSION['kode_log_exe'] : '';
...
<div id="app">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item   <?php if ($page == 'jenis_eo') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=jenis_eo" class='sidebar-link'>
            ...
            <li class="sidebar-title">Email Executive Order</li>
            
            <li
                class="sidebar-item   <?php if ($page == 'new') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=new" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
                    <span>New</span>
                </a>
            </li>
            ...
            <li
                ...
                <a href="index.php?page=list" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
                    <span>List</span>
                </a>
            </li>
            <li
                class="sidebar-item   <?php if ($page == 'list_posting') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=list_posting" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
                    <span>List Posted</span>
                </a>
            </li>
